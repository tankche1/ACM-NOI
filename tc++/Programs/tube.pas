...
procedure Swap(var a, b : edge_type); inline;
  var
    t : edge_type;
  begin
    t := a;
...
procedure QSort1(head, tail : longint); inline;
  var
    mid : edge_type;
    i, j : longint;
  begin
...
procedure QSort2(head, tail : longint); inline;
  var
    mid : edge_type;
    i, j : longint;
  begin
...
function Binary_Search(a, b, tot : longint) : longint; inline;
  var
...
function Find_Set(x : longint) : longint; inline;
  var
    t, res, bak : longint;
  begin
    res := x;
...
procedure Union(a, b : longint); inline;
  begin
    a := Find_Set(a);
    b := Find_Set(b);
...
procedure Update(x : pointer); inline;
  var
    a, b, c : longint;
  begin
    if x = Null then exit;
...
procedure Reverse(x : pointer); inline;
  begin
    if x = Null then exit;
    x^.rev := not x^.rev;
    Swap(x^.ch[0], x^.ch[1]);
...
procedure Push_Down(x : pointer); inline;
  begin
...
procedure Splay(x : pointer); inline;
  var
    y, z : pointer;
  begin
    Push_Down(x);
...
function Get_Top(x : pointer) : pointer; inline;
  begin
    while true do
      begin
        Push_Down(x);
...
procedure Expose(x : pointer); inline;
  var
    u, v : pointer;
  begin
    u := x;
...
function Query_Max(a, b : longint) : longint; inline;
  var
    u, v : pointer;
    res, x, y : longint;
  begin
...
procedure Ins_Edge(a, b, w, c : longint); inline;
  var
    p : ^edge_node;
  begin
    new(p);
...
procedure Make_GE(n : longint); inline;
  var
    i : longint;
  begin
...
function New_Node() : pointer; inline;
  var
    p : pointer;
  begin
    new(p);
...
procedure Make_Tree(n : longint); inline;
  var
    i, head, tail : longint;
    p : ^edge_node;
  begin
